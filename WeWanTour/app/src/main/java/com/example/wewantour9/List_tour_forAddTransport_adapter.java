...
public class List_tour_forAddTransport_adapter extends RecyclerView.Adapter<List_tour_forAddTransport_adapter.ImageViewHolder> {

    private Context mContext;
    private List<Tour> uploads;

    public List_tour_forAddTransport_adapter(Context mContext, List<Tour> uploads) {
    ...
    public ImageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.tour_list_tour_foraddtransport, parent, false);
        return new List_tour_forAddTransport_adapter.ImageViewHolder(v);
    }
